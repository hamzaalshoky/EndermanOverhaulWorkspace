...
public class NetherWastesEndermanRenderer extends GeoEntityRenderer<NetherWastesEndermanEntity> {
    ...
    public NetherWastesEndermanRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addLayer(new NetherWastesEndermanEyesLayer<>(this));
    }

    @Override
    public ResourceLocation getTextureLocation(NetherWastesEndermanEntity instance) {
        return new ResourceLocation(EndermanOverhaul.MOD_ID, "textures/entity/nether_wastes/nether_wastes_enderman.png");
    }


    @Override
    public RenderType getRenderType(NetherWastesEndermanEntity animatable, float partialTicks, PoseStack stack,
    ...
    public Vec3 getRenderOffset(NetherWastesEndermanEntity p_114336_, float p_114337_) {
