...
public class WarpedForestEndermanRenderer extends GeoEntityRenderer<WarpedForestEndermanEntity> {
    ...
    public WarpedForestEndermanRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addLayer(new WarpedForestEndermanEyesLayer<>(this));
    }

    @Override
    public ResourceLocation getTextureLocation(WarpedForestEndermanEntity instance) {
        return new ResourceLocation(EndermanOverhaul.MOD_ID, "textures/entity/warped_forest/warped_enderman.png");
    }


    @Override
    public RenderType getRenderType(WarpedForestEndermanEntity animatable, float partialTicks, PoseStack stack,
    ...
    public Vec3 getRenderOffset(WarpedForestEndermanEntity p_114336_, float p_114337_) {
