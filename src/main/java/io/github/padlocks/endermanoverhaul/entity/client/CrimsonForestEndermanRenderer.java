...
public class CrimsonForestEndermanRenderer extends GeoEntityRenderer<CrimsonForestEndermanEntity> {
    ...
    public CrimsonForestEndermanRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addLayer(new CrimsonEndermanEyesLayer<>(this));
    }

    @Override
    public ResourceLocation getTextureLocation(CrimsonForestEndermanEntity instance) {
        return new ResourceLocation(EndermanOverhaul.MOD_ID, "textures/entity/crimson_forest/crimson_forest_enderman.png");
    }


    @Override
    public RenderType getRenderType(CrimsonForestEndermanEntity animatable, float partialTicks, PoseStack stack,
    ...
    public Vec3 getRenderOffset(CrimsonForestEndermanEntity p_114336_, float p_114337_) {
