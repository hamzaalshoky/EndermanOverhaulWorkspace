...
public class DesertEndermanRenderer extends GeoEntityRenderer<DesertEndermanEntity> {
    ...
    public DesertEndermanRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addLayer(new DesertEndermanEyesLayer<>(this));
    }

    @Override
    public ResourceLocation getTextureLocation(DesertEndermanEntity instance) {
        return new ResourceLocation(EndermanOverhaul.MOD_ID, "textures/entity/desert/desert_enderman.png");
    }


    @Override
    public RenderType getRenderType(DesertEndermanEntity animatable, float partialTicks, PoseStack stack,
    ...
    public Vec3 getRenderOffset(DesertEndermanEntity p_114336_, float p_114337_) {
