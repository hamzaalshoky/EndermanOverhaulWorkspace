...
public class IceSpikesEndermanRenderer extends GeoEntityRenderer<IceSpikesEndermanEntity> {
    ...
    public IceSpikesEndermanRenderer(EntityRendererProvider.Context renderManager) {
        ...
        this.addLayer(new IceSpikesEndermanEyesLayer<>(this));
    }

    @Override
    public ResourceLocation getTextureLocation(IceSpikesEndermanEntity instance) {
        return new ResourceLocation(EndermanOverhaul.MOD_ID, "textures/entity/ice_spikes/ice_spikes_enderman.png");
    }


    @Override
    public RenderType getRenderType(IceSpikesEndermanEntity animatable, float partialTicks, PoseStack stack,
    ...
    public Vec3 getRenderOffset(IceSpikesEndermanEntity p_114336_, float p_114337_) {
