...
public class EndIslandsEndermanRenderer extends GeoEntityRenderer<EndIslandsEndermanEntity> {
    ...
    @Override
    public ResourceLocation getTextureLocation(EndIslandsEndermanEntity instance) {
        return new ResourceLocation(EndermanOverhaul.MOD_ID, "textures/entity/end_islands/end_islands_enderman.png");
    }


    @Override
    public RenderType getRenderType(EndIslandsEndermanEntity animatable, float partialTicks, PoseStack stack,
    ...
    public Vec3 getRenderOffset(EndIslandsEndermanEntity p_114336_, float p_114337_) {
